...
class Assistance:
    ...
    async def deltheme(self):
        """Deleting home menu theme data"""f
    ...
    async def sdlock(self):
        ...
        await self.simple_embed("This switch on the SD Card should be facing upwards, as in this photo. Otherwise, your device will refuse to write to it. /nIf it is write locked, it may conflict with your progress.*", title="Disable write protection on an SD Card")
